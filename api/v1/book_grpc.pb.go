...
type BookServiceClient interface {
	CreateBook(ctx context.Context, in *CreateBookRequest, opts ...grpc.CallOption) (*CreateBookResp, error)
	RetrieveBook(ctx context.Context, in *RetrieveBookRequest, opts ...grpc.CallOption) (*RetrieveBookResp, error)
...
func (c *bookServiceClient) CreateBook(ctx context.Context, in *CreateBookRequest, opts ...grpc.CallOption) (*CreateBookResp, error) {
...
func (c *bookServiceClient) RetrieveBook(ctx context.Context, in *RetrieveBookRequest, opts ...grpc.CallOption) (*RetrieveBookResp, error) {
	out := new(RetrieveBookResp)
...
type BookServiceServer interface {
	CreateBook(context.Context, *CreateBookRequest) (*CreateBookResp, error)
	RetrieveBook(context.Context, *RetrieveBookRequest) (*RetrieveBookResp, error)
...
func (UnimplementedBookServiceServer) CreateBook(context.Context, *CreateBookRequest) (*CreateBookResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBook not implemented")
}
func (UnimplementedBookServiceServer) RetrieveBook(context.Context, *RetrieveBookRequest) (*RetrieveBookResp, error) {
